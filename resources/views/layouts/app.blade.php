...
<body class="bg-background text-textPrimary font-sans antialiased min-h-screen flex items-center justify-center px-4">
    ...
    <div class="min-h-screen bg-gray-100 dark:bg-[#fffaf0]">
        ...
        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
            ...
            @else
                ...
                <a href="{{ route('register') }}" class="ml-4 inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-500 active:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition ease-in-out duration-150">
                    Sign up
                </a>
            @endauth
        </div>
